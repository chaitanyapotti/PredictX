...
export const PredictX_CONTRACT_ADDRESS = PredictX_CONTRACT_ADDRESS_CHAINS.SEPOLIA;
...
export const USDC_CONTRACT_ADDRESS = USDC_CONTRACT_ADDRESS_CHAINS.SEPOLIA;
